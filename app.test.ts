...
test.describe('Social Media Content Generator - Application Launch Test', () => {
  ...
  test('application loads successfully', async ({ page }: { page: Page }) => {
    await page.goto('/');
  ...
  test('form is present with all required fields', async ({ page }: { page: Page }) => {
    await page.goto('/');
  ...
  test('form validation works', async ({ page }: { page: Page }) => {
    await page.goto('/');
  ...
  test('content generation works end-to-end', async ({ page }: { page: Page }) => {
    await page.goto('/');
  ...
  test('copy button works', async ({ page }: { page: Page }) => {
  ...
  test('reset button works', async ({ page }: { page: Page }) => {
    await page.goto('/');
  ...
  test('responsive design - mobile viewport', async ({ page }: { page: Page }) => {
    // Set mobile viewport
